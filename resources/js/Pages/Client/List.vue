        ...
        <div class="py-12">
            <div
                ...
                <div class="p-6 flex justify-between items-center border-b border-gray-300 dark:border-gray-700">
                    <h3 class="text-xl font-bold text-gray-800 dark:text-white">Lista de Clientes</h3>
                </div>
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center w-full mt-6">
                        <div class="text-gray-800 dark:text-gray-300 text-sm">Mostrando {{ clients.from }} a {{
                            clients.to }} de
                            un total de {{ clients.total }} registros</div>
